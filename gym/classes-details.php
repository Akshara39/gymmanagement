	...
	<div class="infor-model-warp">
		<div class="infor-model d-flex align-items-center">
			...
			<div class="infor-middle">
				...
				<p>Get ready to relax ur mind and body by enrolling into our classes with the help of best trainers.</p>
					...
					<div class="classes-other-slider owl-carousel">
						<div class="classes-item">
							...
							<div class="ci-text">
								...
								<p>Artistic yoga is a type of yoga that incorporates various artistic elements, such as dance-like movements, creative sequences, and expressive posturest enim ad minima veniam, quis nostrum exercitationem ullam corporis</p>
							</div>
							<div class="ci-bottom">
								<div class="ci-author">
						...
						<div class="classes-item">
							...
							<div class="ci-text">
								...
								<p>Traditional Hatha yoga is a form of yoga that focuses on physical postures (asanas), breath control (pranayama), and meditation</p>
							</div>
							<div class="ci-bottom">
								<div class="ci-author">
						...
						<div class="classes-item">
							...
							<div class="ci-text">
								...
								<p>Yoga therapy is a type of complementary and alternative medicine (CAM) that uses yoga practices and principles to improve physical and mental healthUt enim ad minima veniam, quis nostrum exercitationem ullam corporis</p>
							</div>
							<div class="ci-bottom">
								<div class="ci-author">
				...
				<div class="col-lg-3 col-md-5 col-sm-8 sidebar">
					<div class="sb-widget">
						...
						<div class="classes-info">
							<ul>
								<li><i class="material-icons">map</i>Juhu tara road,Sanatcruz(W)</li>
								<li><i class="material-icons">event_available</i>15 January, 2023</li>
