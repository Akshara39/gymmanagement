							...
							<div class="classes-item-warp">
								<div class="classes-item">
									...
									<div class="ci-text">
										...
										<p>Artistic yoga is a type of yoga that incorporates various artistic elements, such as dance-like movements, creative sequences, and expressive postures</p>
									</div>
									<div class="ci-bottom">
										<div class="ci-author">
							...
							<div class="classes-item-warp">
								<div class="classes-item">
									...
									<div class="ci-text">
										...
										<p>Yoga therapy is a type of complementary and alternative medicine (CAM) that uses yoga practices and principles to improve physical and mental health.</p>
									</div>
									<div class="ci-bottom">
										<div class="ci-author">
