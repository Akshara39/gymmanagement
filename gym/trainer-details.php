	...
	<div class="infor-model-warp">
		<div class="infor-model d-flex align-items-center">
			...
			<div class="infor-middle">
				...
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor inciYoga trainers are professionals who teach and guide individuals in the practice of yoga. They are trained and certified to instruct people in various styles of yoga, as well as to develop personalized yoga programs for individuals based on their needs and goals.</p>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7 m-auto text-white">
					...
					<p>Yoga trainers are professionals who teach and guide individuals in the practice of yoga. They are trained and certified to instruct people in various styles of yoga, as well as to develop personalized yoga programs for individuals based on their needs and goals.</p>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="trainer-details">
				...
				<div class="trainer-details-text">
					<h3>About Yoga</h3>
					<p>
Yoga is a physical, mental, and spiritual practice that originated in ancient India. It involves a series of postures, breathing exercises, and meditation techniques designed to promote physical and mental wellbeing.</p>
					<ul>
