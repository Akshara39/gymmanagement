				...
				<div class="col-lg-6">
					<div class="trainer-item">
						...
						<div class="ti-text">
							<h4>Lori Kennedy</h4>
							<h6>Yoga Trainer</h6>
							<p>The Kripalu Center for Yoga & Health, USA</p>
							<div class="ti-social">
								<a href="#"><i class="fa fa-facebook"></i></a>
								<a href="#"><i class="fa fa-instagram"></i></a>
								<a href="#"><i class="fa fa-twitter"></i></a>
					...
					<div class="ts-item">
						<div class="trainer-item">
							...
							<div class="ti-text">
								<h4>Cynthia McCoy</h4>
								<h6>Yoga Trainer</h6>
								<p>The Yoga Therapy Institute, Australia</p>
								<div class="ti-social">
									<a href="#"><i class="fa fa-facebook"></i></a>
									<a href="#"><i class="fa fa-instagram"></i></a>
									<a href="#"><i class="fa fa-twitter"></i></a>
					...
					<div class="ts-item">
						<div class="trainer-item">
							...
							<div class="ti-text">
								...
								<h6>Yoga Trainer</h6>
								<p>Certification from the National Institute of Sports Medicine (NASM) USA.</p>
								<div class="ti-social">
									<a href="#"><i class="fa fa-facebook"></i></a>
									<a href="#"><i class="fa fa-instagram"></i></a>
									<a href="#"><i class="fa fa-twitter"></i></a>
